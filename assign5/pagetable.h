...
// A page table entry
/**
 * @brief A page table entry. This class is used to represent a page table
 * entry.
 * @details Each page has one entry in the page table. It contains the following
 * fields:
 * - frame number
 * - valid bit
 */
 ...
 * The size of the page table should equal to the number of pages in logical
 * memory
 */
class PageTable {
private:
...
public:
   ...
   * @return
   */
  PageEntry &operator[](int i) { return pages[i]; }
};
