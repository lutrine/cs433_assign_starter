...
public:
   ...
   *          If the page is not valid but free frames are available, it calls
   * the load_page function. If the page is not valid and there is no free
   * frame, it calls the replace_page function.
   ...
   * It is a pure virtual function to be implemented in specific replacement
   * subclasses.
   ...
   */
  PageEntry getPageEntry(int page_num) { return page_table[page_num]; }
